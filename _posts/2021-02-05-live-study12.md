...
```java @Target(ElementType.METHOD) @Retention(RetentionPolicy.SOURCE) public @interface Override { ...} ``` 
...
남궁성. Java의 정석
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MTY1OTk4MzAsOTAzNDk0NjQsLTM5OD
Y3MTIyLDE3Mzk1MDQxMTldfQ==
-->