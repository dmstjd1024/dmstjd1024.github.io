...
```
예를 들어 Juice를 만드는 클래스가 있다 치자, 여기서 FruitBox의 타입 매개변수 T를 파라미터에 적을 수 없으므로 특정 타입을 지정해줘야 한다.
...
남궁성. Java의 정석
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMzMTk1Njk3MywxNjYyOTQ1ODAsMjA5OD
MzNjQwOCwtODI4NTAxMzQsNjgwMDQ0MDE0LC0xODIwMDczMDUy
LDEzMDM4MzU0MCwxNTE3NTg4ODQ2LDkwODAyNDAyNCwtMTk2NT
