...
### 제네릭 제한
모든 객체에 대해 동일하게 동작해야 하는 static 멤버에 타입 변수 'T'를 사용할 수 없다. T는 인스턴스 변수로 간주되기 때문에 static 멤버는 인스턴스변수를 참조할 수 없다.
## 바운디드 타입
...
남궁성. Java의 정석
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjgwMDQ0MDE0LC0xODIwMDczMDUyLDEzMD
