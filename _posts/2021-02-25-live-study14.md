...
```
예를 들어 Juice를 만드는 클래스가 있다 치자, 여기서 FruitBox의 타입 매개변수 T를 파라미터에 적을 수 없어, 특정 타입을 지정해줘야 한다. 그렇게 제네릭 타입을 FruitBox<Fruit>로 지정하면 FruitBox<Apple>은 makeJuice의 매개변수가 될 수 없
...
남궁성. Java의 정석
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcxNDUyNTkxLDEzMzE5NTY5NzMsMTY2Mj
k0NTgwLDIwOTgzMzY0MDgsLTgyODUwMTM0LDY4MDA0NDAxNCwt
MTgyMDA3MzA1MiwxMzAzODM1NDAsMTUxNzU4ODg0Niw5MDgwMj
QwMjQsLTE5NjU3ODU2ODMsLTE5NjU3ODU2ODMsLTM5MTc0ODQ1
MywyMDYwNDU1ODM1LC04NTQ1OTgwMzUsLTYyMjc5MDA0LC0zMD
g5OTU5NDUsMTQ0OTA0NzE0OV19
-->