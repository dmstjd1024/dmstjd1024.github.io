...
<div class="diagram" role="img" aria-label="DTO, VO, Entity 의 목적과 같음의 기준 비교">
{% include diagrams/dto--dto-vo-entity.svg %}
</div>
...
<div class="diagram" role="img" aria-label="DTO 를 쓰는 구간과 Entity 를 쓰는 구간의 경계">
{% include diagrams/dto--layer-boundary.svg %}
</div>
