...
<div class="diagram" role="img" aria-label="유지 정책별로 애노테이션이 남는 단계">
{% include diagrams/live-study12--retention.svg %}
</div>
...
<div class="diagram" role="img" aria-label="애노테이션 프로세서가 컴파일 시점에 코드를 생성하는 과정">
{% include diagrams/live-study12--annotation-processor.svg %}
</div>
