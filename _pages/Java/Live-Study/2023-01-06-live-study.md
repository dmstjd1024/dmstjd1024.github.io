...
<div class="diagram" role="img" aria-label="일반 애플리케이션과 자바 애플리케이션의 실행 경로 비교">
{% include diagrams/live-study--jvm-portability.svg %}
</div>
...
<div class="diagram" role="img" aria-label="자바 소스가 컴파일되어 실행되기까지의 단계">
{% include diagrams/live-study--compile-flow.svg %}
</div>
...
<div class="diagram" role="img" aria-label="인터프리터, 정적 컴파일, JIT 방식 비교">
{% include diagrams/live-study--jit.svg %}
</div>
...
<div class="diagram" role="img" aria-label="Runtime Data Area 네 영역의 공유 여부와 GC 대상 여부">
{% include diagrams/live-study--runtime-data-area.svg %}
</div>
...
<div class="diagram" role="img" aria-label="JDK, JRE, JVM 의 포함 관계">
{% include diagrams/live-study--jdk-jre.svg %}
</div>
