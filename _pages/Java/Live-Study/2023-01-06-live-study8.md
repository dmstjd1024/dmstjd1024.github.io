...
<div class="diagram" role="img" aria-label="인터페이스는 여러 개를 함께 상속받을 수 있다">
{% include diagrams/live-study8--interface-multiple.svg %}
</div>
...
<div class="diagram" role="img" aria-label="디폴트 메서드가 나온 이유와 충돌 규칙">
{% include diagrams/live-study8--default-method.svg %}
</div>
