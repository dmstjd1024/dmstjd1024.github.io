...
<div class="diagram" role="img" aria-label="break 를 생략해 아래 case 로 흘러내리는 동작">
{% include diagrams/live-study4--switch-fallthrough.svg %}
</div>
...
<div class="diagram" role="img" aria-label="for 문의 실행 순서">
{% include diagrams/live-study4--for-order.svg %}
</div>
...
<div class="diagram" role="img" aria-label="while 과 do-while 의 조건 검사 순서 차이">
{% include diagrams/live-study4--while-dowhile.svg %}
</div>
...
<div class="diagram" role="img" aria-label="break 와 continue 의 차이">
{% include diagrams/live-study4--break-continue.svg %}
</div>
