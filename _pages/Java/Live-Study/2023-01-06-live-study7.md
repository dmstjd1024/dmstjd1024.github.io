...
<div class="diagram" role="img" aria-label="클래스 로더가 클래스패스로 클래스를 찾는 흐름">
{% include diagrams/live-study7--classpath.svg %}
</div>
...
<div class="diagram" role="img" aria-label="필드를 감추고 메서드로 검증하는 캡슐화">
{% include diagrams/live-study7--encapsulation.svg %}
</div>
...
<div class="diagram" role="img" aria-label="private 생성자로 인스턴스 생성을 제한하는 싱글톤">
{% include diagrams/live-study7--singleton.svg %}
</div>
