...
<div class="diagram" role="img" aria-label="클래스와 인스턴스의 관계">
{% include diagrams/live-study5--class-instance.svg %}
</div>
...
<div class="diagram" role="img" aria-label="기본 생성자가 자동 추가되는 조건">
{% include diagrams/live-study5--default-constructor.svg %}
</div>
...
<div class="diagram" role="img" aria-label="this() 가 첫 줄에만 올 수 있는 이유">
{% include diagrams/live-study5--this-constructor.svg %}
</div>
