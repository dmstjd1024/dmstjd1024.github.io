...
마지막 날 한꺼번에 떨어진다. 원인은 대개 이 둘 중 하나다.
...
중간에 며칠간 아무것도 완료되지 않았다는 뜻이다. 막힌 이슈가 있거나, 다들 큰 이슈 하나를 붙들고 있는 상황이다.
...
스프린트 중간에 일이 추가됐다. 한두 번은 괜찮지만 매번 그러면 계획 자체를 다시 봐야 한다.
