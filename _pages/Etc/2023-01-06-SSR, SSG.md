...
<div class="diagram" role="img" aria-label="CSR, SSR, SSG 가 HTML 을 만드는 시점 비교">
{% include diagrams/ssr-ssg--rendering-timing.svg %}
</div>
...
<div class="diagram" role="img" aria-label="검색 크롤러가 CSR 과 SSR 에서 받는 HTML 의 차이">
{% include diagrams/ssr-ssg--seo.svg %}
</div>
...
<div class="diagram" role="img" aria-label="Jam Stack 의 정적 배포와 외부 API 분리 구조">
{% include diagrams/ssr-ssg--jamstack.svg %}
</div>