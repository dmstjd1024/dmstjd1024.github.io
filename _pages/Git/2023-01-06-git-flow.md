...
<div class="diagram" role="img" aria-label="JIRA">
{% include diagrams/git-flow--JIRA.svg %}
</div>
...
<div class="diagram" role="img" aria-label="Intellij-Jira">
{% include diagrams/git-flow--intellij-jira.svg %}
</div>
...
<div class="diagram" role="img" aria-label="git-flow-init">
{% include diagrams/git-flow--git-flow-init.svg %}
</div>  
...
<div class="diagram" role="img" aria-label="enter-task-name">
{% include diagrams/git-flow--enter-task-name.svg %}
</div>  

이라고 생성되는데 여기서 하얀줄 같은 경우가 Jira에서 할당받은 이슈가 생성되고 클릭시 그에 맞게

<div class="diagram" role="img" aria-label="feature">
{% include diagrams/git-flow--feature.svg %}
</div>  
